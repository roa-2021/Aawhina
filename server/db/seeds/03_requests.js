exports.seed = function(knex) {
  ...
  //   .then(function () {
      ...
      return knex('requests').insert([
        ...
        {id: 8, user_id: 3, title: 'Weekly shop', category: 'groceries', details: 'I cant get to the supermarket since my injury, need someone to help with the shopping.', time_frame: 'Today', created_at: '2021-09-26'}
      ])
    }
