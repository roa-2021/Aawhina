exports.seed = function (knex) {
  return knex('suburb').insert([
    ...
    { id: 69, name: "Days Bay", region: "Lower Hutt", neighbours: "70, 90" },
    { id: 70, name: "Eastbourne", region: "Lower Hutt", neighbours: "69, 94" },
    ...
    { id: 107, name: "Mangaroa", region: "Upper Hutt", neighbours: "108, 115" },
    ...
    { id: 110, name: "Moonshine", region: "Upper Hutt", neighbours: "113, 92" },
    { id: 111, name: "Parkdale", region: "Upper Hutt", neighbours: "104, 99, 115, 116, 100" },
    { id: 112, name: "Pinehaven", region: "Upper Hutt", neighbours: "114, 117" },
    { id: 113, name: "Riverstone Terraces", region: "Upper Hutt", neighbours: "110, 92" },
    ...
    { id: 132, name: "Moonshine Valley", region: "Porirua", neighbours: "110, 113" },
